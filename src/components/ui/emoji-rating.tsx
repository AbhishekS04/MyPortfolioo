...
export function RatingInteraction({ className }: RatingInteractionProps) {
  ...
  if (submitted) {
    return (
      <div
        className={cn(
          'flex flex-col items-center gap-4 py-8 animate-in fade-in zoom-in duration-500',
          className,
        )}
      >
        <span className="text-5xl mb-2" role="img" aria-label="Success">
          🎉
        </span>
  ...
  return (
    <div className={cn('flex flex-col items-center gap-6', className)}>
              ...
              <div
                className={cn(
                  ...
                  isActive
                    ...
                    : 'scale-100 group-hover:scale-105 group-hover:bg-white/10',
                )}
              >
      ...
      <div className="relative h-6 w-32">
        ...
        >
          <span className="text-xs font-medium tracking-wide text-white/20">
            Select one
          </span>
        </div>
      </div>
