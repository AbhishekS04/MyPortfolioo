            ...
            <AnimatePresence mode="wait">
                {isTriggered && (
                    <div className="fixed inset-0 z-[100000] flex items-center justify-center pointer-events-auto">
                        ...
                        >
                            <div className="relative rounded-[32px] overflow-hidden shadow-[0_0_150px_rgba(0,0,0,1)] bg-black/20 ring-1 ring-white/10 group">
                                ...
                                <button
                                    ...
                                    className="absolute top-6 right-6 opacity-0 group-hover:opacity-100 transition-all duration-500 text-white/40 hover:text-white text-[10px] sm:text-xs uppercase tracking-widest border border-white/10 px-6 py-2.5 rounded-full backdrop-blur-2xl bg-black/40 hover:bg-black/80 shadow-2xl translate-y-2 group-hover:translate-y-0"
                                >
                                    [ TERMINATE ]
                                </button>
                            </div>
                        ...
                        >
                            <span className="text-white/10 text-[10px] sm:text-xs font-mono tracking-[0.8em] uppercase whitespace-nowrap">
