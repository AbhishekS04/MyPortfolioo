    ...
    return (
      <div className="flex items-center justify-center p-12 border border-dashed border-white/10 rounded-xl">
        <p className="text-white/40 text-sm">
          Please save the project first before adding contributors.
        </p>
      </div>
    );
  }
    ...
    <div className="space-y-6 animate-in fade-in slide-in-from-bottom-4 duration-300">
        ...
        {contributors.map((c) => (
          ...
          >
            ...
            <button
              ...
              aria-label={`Remove contributor ${c.name}`}
      ...
      <div className="p-4 rounded-2xl bg-white/5 border border-white/5 space-y-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <label className="sr-only" htmlFor="contrib-name">
            Name
          </label>
          <input
            id="contrib-name"
          ...
          />
          <label className="sr-only" htmlFor="contrib-role">
            Role
          </label>
          <input
            id="contrib-role"
            ...
            className="bg-[#111] border border-white/10 rounded-lg px-3 py-2 text-sm text-white focus:outline-none focus:border-white/20"
          />
          <label className="sr-only" htmlFor="contrib-avatar">
            Avatar URL
          </label>
          <input
            id="contrib-avatar"
            ...
            className="bg-[#111] border border-white/10 rounded-lg px-3 py-2 text-sm text-white focus:outline-none focus:border-white/20"
          />
          <label className="sr-only" htmlFor="contrib-social">
            Social URL
          </label>
          <input
            id="contrib-social"
