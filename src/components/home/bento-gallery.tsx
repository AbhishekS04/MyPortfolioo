  ...
  return (
    <section className="w-full max-w-[1400px] mx-auto px-4 md:px-6 pb-12 pt-4 md:py-24 lg:py-0">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 auto-rows-min items-start">
        ...
        {/* 2. Gallery/Phone - Center Column (Spans 2 Rows on Desktop and Tablet) */}
        <div className="order-2 md:order-3 lg:order-2 md:col-span-1 lg:col-span-1 md:row-span-2 lg:row-span-2 h-[400px] md:h-[504px] lg:h-[764px] bg-[#111] rounded-[32px] border border-white/5 overflow-hidden relative shadow-2xl">
