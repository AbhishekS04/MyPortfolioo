...
export function FocusCard() {
    ...
    return (
        <div
            ...
            className="w-full h-full bg-[#111111] border border-white/5 rounded-[32px] overflow-hidden flex flex-col p-6 sm:p-8 relative group hover:border-white/10 transition-colors cursor-pointer"
        >
            {/* Main Content Layout */}
                ...
                <div className="flex flex-col gap-6 overflow-y-auto pr-2 scrollbar-hide mask-image-b w-full relative z-10">
                        ...
                        <div className="flex items-center gap-3 sticky top-0 bg-[#111111]/95 backdrop-blur-sm py-2 z-20">
                            <motion.div
                                animate={{
                                    ...
                                    scale: [1, 1.2, 1],
                                    boxShadow: isGolden
                                        ? ["0 0 0px rgba(234,179,8,0)", "0 0 12px rgba(234,179,8,0.8)", "0 0 0px rgba(234,179,8,0)"]
                                        : ["0 0 0px rgba(59,130,246,0)", "0 0 12px rgba(59,130,246,0.6)", "0 0 0px rgba(59,130,246,0)"]
                                }}
                    ...
                    <div className="flex flex-col gap-3 mt-2">
                        ...
                        <div className="flex items-center gap-3 sticky top-0 bg-[#111111]/95 backdrop-blur-sm py-2 z-20">
                            <motion.div
                                animate={{
                                    ...
                                    boxShadow: isGolden
                                        ? ["0 0 0px rgba(234,179,8,0)", "0 0 12px rgba(234,179,8,0.8)", "0 0 0px rgba(234,179,8,0)"]
                                        : ["0 0 0px rgba(239,68,68,0)", "0 0 12px rgba(239,68,68,0.6)", "0 0 0px rgba(239,68,68,0)"]
                                }}
                        ...
                        <div className={`flex items-center gap-4 text-white/50 hover:text-[#4169E1] transition-all duration-300 group/item pl-1 ${isGolden ? "opacity-100" : "opacity-100"}`}>
                            ...
                            <span className="text-[10px] sm:text-xs font-semibold tracking-wide leading-tight uppercase font-mono">SQL, Neon & NoSQL</span>
                        </div>
                        ...
                        <div className={`flex items-center gap-4 text-white/50 hover:text-[#DEA584] transition-all duration-300 group/item pl-1 ${isGolden ? "opacity-20 blur-[0.5px] scale-95" : "opacity-100"}`}>
                            <div className="flex gap-1.5">
                        ...
                        <div className={`flex items-center gap-4 text-white/50 hover:text-[#2496ED] transition-all duration-300 group/item pl-1 ${isGolden ? "opacity-20 blur-[0.5px] scale-95" : "opacity-100"}`}>
                            <div className="flex gap-1.5">
                        ...
                        <div className={`flex items-center gap-4 text-white/50 hover:text-[#3ECF8E] transition-all duration-300 group/item pl-1 ${isGolden ? "opacity-100" : "opacity-100"}`}>
                            ...
                            <span className="text-[10px] sm:text-xs font-semibold tracking-wide uppercase font-mono">Supabase & Convex</span>
                        </div>
