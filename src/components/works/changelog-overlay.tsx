...
export function ChangelogOverlay({
  ...
  const totalPages = isCommitsArray
    ? Math.ceil(commits.length / itemsPerPage)
    : 0;
            ...
            <div className="p-6 sm:p-8 border-b border-white/10 flex items-center justify-between relative overflow-hidden group">
              ...
              <div className="flex items-center gap-5 relative z-10">
                ...
                <div className="flex-1 min-w-0">
                  <h2 className="text-xl sm:text-2xl font-black text-white tracking-tighter uppercase italic truncate">
                    {projectTitle}
                  </h2>
                  <p className="text-[10px] uppercase font-black tracking-[0.3em] text-white/30 hidden sm:block">
                    System_Protocol::V_HISTORY
                  </p>
                </div>
              </div>
            ...
            <div className="flex-1 p-6 sm:p-8 space-y-6 overflow-hidden min-h-[400px]">
              {loading ? (
                <div className="h-80 flex flex-col items-center justify-center gap-6">
                  ...
                  <p className="text-[10px] uppercase font-black tracking-[0.5em] text-white/20 animate-pulse italic">
