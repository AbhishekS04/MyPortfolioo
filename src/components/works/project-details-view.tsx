          ...
          >
            ...
            <div className="lg:col-span-5 flex flex-wrap content-start gap-2">
              {project.tech_stack?.map((tech: string) => (
                <span
                  key={tech}
                  className="px-4 py-2 rounded-full text-xs font-medium tracking-wider uppercase text-blue-100/60 bg-blue-900/10 border border-blue-500/10 backdrop-blur-sm"
                >
                  {tech}
                </span>
              ))}
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-24 mb-32 relative">
          ...
          <aside className="lg:col-span-4 lg:col-start-9 h-fit lg:sticky lg:top-32 space-y-16">
            ...
            {(markdownHighlights || project.features) && (
              ...
              >
                <h4 className="px-6 py-4 text-xs font-bold text-blue-200/80 uppercase tracking-[0.2em] border-b border-white/5">
                  Highlights
                </h4>
