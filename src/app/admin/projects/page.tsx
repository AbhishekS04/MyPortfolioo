...
export default function AdminProjects() {
  ...
  const handleToggleHidden = async (project: Project) => {
    ...
    setProjects(
      projects.map((p) =>
        p.id === project.id ? { ...p, is_hidden: newHiddenStatus } : p,
      ),
    );
  ...
  const setTechInputLocal = (val: string) =>
    setFormState((prev) => ({ ...prev, techInput: val }));
  const setGalleryInputLocal = (val: string) =>
    setFormState((prev) => ({ ...prev, galleryInput: val }));
            ...
            >
              ...
              <div className="flex-1 min-w-0">
                <div className="flex items-center gap-3 mb-1">
                  ...
                  <span className="text-xs text-white/30 font-mono hidden md:inline-block">
                    /works/{project.slug}
                  </span>
                    ...
                    <div className="space-y-6 animate-in fade-in slide-in-from-bottom-4 duration-300">
                      <div className="space-y-2">
                        <label className="text-xs font-medium text-white/40 uppercase tracking-widest flex items-center gap-2">
                          <ImageIcon className="w-3 h-3" /> Main Cover Image
                          (Required)
                        </label>
                        <input
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div className="space-y-2">
                          ...
                          >
                            ...
                            <option value="video_first">
                              Video First (then Gallery)
                            </option>
                          </select>
                        </div>
                      </div>
                  ...
                  {activeTab === "settings" && (
                    <div className="space-y-6 animate-in fade-in slide-in-from-bottom-4 duration-300">
                      ...
                      <div className="flex flex-col gap-3 pt-4">
                        ...
                        <button
                          onClick={() =>
                            updateFormData({ featured: !formData.featured })
                          }
                          className={`w-full px-4 py-3 rounded-xl border transition-all text-sm font-medium flex items-center justify-center gap-2 ${
                            formData.featured
