...
export default function AdminContact() {
  ...
  const removeTag = (tagToRemove: string) => {
    setFormData({
      ...formData,
      availability_items: formData.availability_items.filter(
        (tag) => tag !== tagToRemove,
      ),
    });
  };
  ...
  return (
    <div className="min-h-screen p-6 md:p-12 max-w-4xl mx-auto pb-32">
      ...
      >
          ...
          <div className="p-6 md:p-8 bg-[#111] border border-white/5 rounded-[32px] space-y-6">
            <div className="space-y-2">
              ...
              <p className="text-xs text-white/20">
                The large text displayed at the top of the contact page.
              </p>
            </div>
          </div>
        </section>
          ...
          <div className="p-6 md:p-8 bg-[#111] border border-white/5 rounded-[32px] space-y-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 items-start">
              <div className="space-y-3">
                <label className="text-xs font-medium text-white/40 uppercase tracking-widest block">
                  Availability Signal
                </label>
                <button
                  onClick={() =>
            ...
            <div className="space-y-3">
              ...
              <div className="flex flex-wrap gap-2 mb-3">
                {formData.availability_items.map((item, idx) => (
                  <div
                    key={idx}
                    className="group flex items-center gap-2 pl-3 pr-2 py-1.5 rounded-full bg-white/5 border border-white/10 hover:border-red-500/30 transition-colors"
                  >
        ...
        <section className="space-y-6">
          <div className="flex items-center gap-3 mb-6">
            <div className="w-5 h-5 rounded-full border border-current text-blue-400 flex items-center justify-center text-[10px] font-bold">
              @
            </div>
            <h2 className="text-xl font-medium text-white">
              Social Media Links
