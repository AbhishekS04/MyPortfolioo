...
export default function MFAVerifyPage() {
    ...
    const handleVerify = async (e: React.FormEvent) => {
        ...
        try {
            ...
            const { data: arrayFactors, error: listError } = await supabase.auth.mfa.listFactors();
            if (listError) throw listError;

            const totpFactor = arrayFactors.totp.find(factor => factor.status === 'verified');
            if (!totpFactor) {
            ...
            // 2. Challenge
            const { data, error: challengeError } = await supabase.auth.mfa.challengeAndVerify({
        ...
        <div className="min-h-screen bg-[#050505] flex items-center justify-center p-6 text-white">
            ...
            <div className="max-w-md w-full relative z-10 bg-[#111] border border-white/10 rounded-3xl p-8 shadow-2xl">
                ...
                <div className="text-center mb-8">
                    ...
                    <h1 className="text-2xl font-bold tracking-tight mb-2">Security Check</h1>
